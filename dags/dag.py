...
def get_amazon_data_books_from_web(num_books, ti):
    ...
    while len(books) < num_books:
        ...
        if response.status_code == 200:
            ...
            for book in book_containers:
                title = book.find("a", {"class": "a-text-normal"})
...
def insert_book_data_into_postgres(ti):
    ...
    postgres_hook = PostgresHook(postgres_conn_id='amz_books_connection')
    insert_query = """
...
dag = DAG(
    ...
    description='DAG to fetch book data from Amazon and store it in Postgres',
...
fetch_book_data_task = PythonOperator(
    ...
    python_callable=get_amazon_data_books_from_web,
...
create_table_task = PostgresOperator(
    ...
    postgres_conn_id='amz_books_connection',
    sql="""
